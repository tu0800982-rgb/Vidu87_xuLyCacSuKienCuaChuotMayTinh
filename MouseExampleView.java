...
private JPanel jPanel_mouse; // Biến toàn cục
private JLabel jLabel_position; // Biến toàn cục
...
private JLabel jLabel_empty_2; // Biến toàn cục
...
public void enter() {  // Đưa con chuột vào chương trình thì sẽ chạy ra Yes
	this.model.enter();
	this.jLabel_check_in_value.setText(this.model.getCheckIn());
}

public void exit() { // Đưa con chuột ra ngoài chương trình thì sẽ chạy ra NO
	this.model.exit();
	this.jLabel_check_in_value.setText(this.model.getCheckIn());
}
